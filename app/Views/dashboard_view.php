       ...
       <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-12">
            <div class="info-box bg-success">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-text"><?=$cSupplier?> Total Supplier</span>
        ...
        <div class="row">
          ...
          <div class="col-4">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> <i class="fas fa-user"></i> List Supplier</h3>
                ...
                <div class="card-tools">
                  ...
                  <div class="input-group input-group-sm" style="width: 150px;">
                    ...
                    <div class="input-group-append">
                      ...
                      <a href="<?php echo site_url('Dashboard/add_supplier/')?>"  class="btn btn-default">
                        <i class="fas fa-plus"></i>
                      </a>
                    </div>
                  </div>
                ...
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <?= $row['alamat'] ?> </td>
                      <td> 
                        <a class="btn btn-primary btn-sm" href="<?php echo site_url('Dashboard/editSupplier/'.$row['id']) ?>" ><i class="fas fa-edit"></i> </a> 
                        <a class="btn btn-danger btn-sm" href="<?php echo site_url('Dashboard/deleteSupplier/'.$row['id']) ?>" ><i class="fas fa-trash"></i> </a> 
