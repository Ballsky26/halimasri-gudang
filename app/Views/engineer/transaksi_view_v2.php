  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3 ">
          <a href="<?php echo site_url('Operate/index2') ?>" class="info-box bg-info">
        ...
        <div class="col-md-3 ">
          <a href="<?php echo site_url('Operate/index2_distibutor') ?>" class="info-box bg-danger">
        ...
        <div class="col-md-6 ">
          <a href="<?php echo site_url('Operate/all_trans_v2') ?>" class="info-box bg-warning">
