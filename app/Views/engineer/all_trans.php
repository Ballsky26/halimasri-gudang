        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="formSubmit" action="/index.php/operate/all_trans_search" method="post">
                <?= csrf_field(); ?>
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td> <?= abs($row->value) ?> </td>
                        <td>
                          <div id="qrcode<?= $row->id_trans ?>"></div>
                        </td>
                        <script type="text/javascript">
                          var qrcode = new QRCode(document.getElementById("qrcode<?= $row->id_trans ?>"), {
                            text: "<?php echo site_url('Operate/detail_trans/' . $row->id_trans) ?>",
                            width: 208,
                            height: 208,
                            colorLight: "#ffffff",
